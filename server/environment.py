...
TASK_CONFIGS: Dict[str, Dict[str, Any]] = {
    "easy": {
        ...
        "logs": {
            "worker-node": (
                ...
                "[2026-04-05T07:15:00Z] [INFO]  consumer throughput: 100 msg/min per replica\n"
                "[2026-04-05T07:15:00Z] [INFO]  current replicas: 2, inbound rate: ~400 msg/min\n"
                "[2026-04-05T07:14:30Z] [INFO]  HPA status: disabled (manual scaling mode)\n"
                "[2026-04-05T07:14:00Z] [ERROR] consumer lag increasing — messages arriving faster than being processed"
            ),
            "order-processing-queue": (
                "[2026-04-05T07:15:45Z] [CRITICAL] queue depth 500/1000 — 50% capacity\n"
                "[2026-04-05T07:15:30Z] [WARN]  message age (oldest): 12 minutes — SLA threshold: 15 min\n"
                "[2026-04-05T07:15:00Z] [WARN]  inbound rate: +200 msg/min, current drain rate: ~200 msg/min\n"
                "[2026-04-05T07:15:00Z] [INFO]  net throughput: ~0 msg/min — queue depth stable, not draining\n"
                "[2026-04-05T07:14:30Z] [INFO]  dead letter queue: 0 messages\n"
                "[2026-04-05T07:14:00Z] [INFO]  max queue capacity: 1000 messages — overflow policy: drop oldest"
            ),
            "api-gateway": (
                "[2026-04-05T07:15:00Z] [INFO]  api-gateway healthy — no errors detected\n"
                "[2026-04-05T07:14:30Z] [INFO]  latency p99: 450ms (elevated)\n"
                "[2026-04-05T07:14:00Z] [INFO]  upstream dependencies: worker-node:8080, database:5432"
            ),
        },
    ...
    "medium": {
        ...
        "logs": {
            "api-gateway": (
                ...
                "[2026-04-05T08:00:05Z] [ERROR] 15% of requests returning 500 — all on /checkout endpoint\n"
                "[2026-04-05T07:59:50Z] [WARN]  error rate climbing: 15.0% and rising — customer impact confirmed\n"
                "[2026-04-05T07:59:30Z] [WARN]  first occurrence correlates with v2.1.0 rollout timestamp (deployed 45 min ago)\n"
                "[2026-04-05T07:59:00Z] [INFO]  v2.1.0 changelog: refactored PaymentHandler to support new card types\n"
                "[2026-04-05T07:58:30Z] [INFO]  deployment history: v2.0.9 (14 days), v2.0.8 (21 days), v2.0.7 (30 days)\n"
                "[2026-04-05T07:58:00Z] [INFO]  error rate before v2.1.0: 0.1% (baseline)\n"
    ...
    "memory_leak": {
        ...
        "logs": {
            "payment-service": (
                ...
                "[2026-04-05T08:55:17Z] [DEBUG] jmap -histo: top heap consumers:\n"
                "[2026-04-05T08:55:17Z] [DEBUG]   1. com.app.cache.ProductCatalogCache  482,291 objects  1.2Gi\n"
                "[2026-04-05T08:55:17Z] [DEBUG]   2. java.lang.String                   120,445 objects  89Mi\n"
                "[2026-04-05T08:55:17Z] [DEBUG]   3. byte[]                              95,200 objects  76Mi\n"
                "[2026-04-05T08:55:17Z] [DEBUG] ProductCatalogCache config: maxSize=unlimited, ttl=none, eviction=disabled\n"
                "[2026-04-05T08:41:00Z] [INFO]  heap snapshot: 68% of 2Gi held by ProductCatalogCache\n"
                "[2026-04-05T08:40:55Z] [INFO]  cache growth rate: ~50MB / 10 min (linear, no plateau)\n"
                "[2026-04-05T08:30:12Z] [INFO]  v4.1.0 deployed 5 hours ago — changelog: added product catalog cache\n"
                ...
                "[2026-04-05T04:12:00Z] [INFO]  deployment history: v4.1.0 (current), v4.0.2 (prev, 21 days), v4.0.1 (42 days)"
            ),
            "api-gateway": (
    ...
    "cert_expiry": {
        ...
        "logs": {
            ...
            "service-mesh-proxy": (
                "[2026-04-05T00:00:01Z] [CRITICAL] cert_monitor: certificate validity=EXPIRED, notAfter=2026-04-05T00:00:00Z\n"
                "[2026-04-05T00:00:01Z] [CRITICAL] cert subject=*.internal.mesh, issuer=mesh-ca, serial=0x3A7F\n"
                "[2026-04-05T00:00:01Z] [ERROR] envoy proxy: TLS_CERTIFICATE_EXPIRED — all mTLS handshakes rejected\n"
                "[2026-04-05T00:00:00Z] [ERROR] openssl verify: Verify return code: 10 (certificate has expired)\n"
                "[2026-04-04T23:55:00Z] [WARN]  cert expiry in 5 minutes — alertmanager fired CertExpirySoon\n"
                "[2026-04-04T23:00:00Z] [WARN]  automated rotation failed: vault-agent returned HTTP 403 Forbidden\n"
                "[2026-04-04T22:00:00Z] [INFO]  vault-agent: POST /v1/pki/issue/mesh-ca — 403 permission denied\n"
                "[2026-04-04T21:30:00Z] [INFO]  vault-agent token: issued=2026-03-20, ttl=14d, status=expired (2026-04-03)"
            ),
            "load-balancer": (
